...
interface ModelInterface extends \JsonSerializable
{
    ...
    const PAYMENT_RETURN_REASON_SENDING_INSTITUTION_ACTION_REQUIRED =
        'SENDING_INSTITUTION_ACTION_REQUIRED';
    ...
    const MANDATE_CANCELLATION_REASON_INSTRUCTION_CANCELLED_BY_PAYER =
        'INSTRUCTION_CANCELLED_BY_PAYER';
    const MANDATE_CANCELLATION_REASON_DECEASED = 'DECEASED';
    const MANDATE_CANCELLATION_REASON_SWITCHED = 'SWITCHED';
    const MANDATE_CANCELLATION_REASON_ACCOUNT_CLOSED = 'ACCOUNT_CLOSED';
    const MANDATE_CANCELLATION_REASON_ACCOUNT_TRANSFERRED_TO_NEW_BRANCH =
        'ACCOUNT_TRANSFERRED_TO_NEW_BRANCH';
